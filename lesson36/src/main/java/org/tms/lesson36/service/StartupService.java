...
public class StartupService {
    ...
    public void init() {
        ...
        Client client1 = new Client("client1", Arrays.asList(car1));
        Client client2 = new Client("client2", Arrays.asList(car2));
        Client client3 = new Client("client3", Arrays.asList(car3));
